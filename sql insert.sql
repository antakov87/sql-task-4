...
INSERT INTO track(id, name, track_duration) 
    VALUES(1, 'Забери ключи ', 3.48),
	(2, 'Airplane ', 4.44),
	(3, 'Good God A Woman ', 3.31),
	(4, 'Over The Rainbow ', 4.33),
	(5, 'If The Stars Were Mine ', 2.48),
	(6, 'Звезда по имени Солнце ', 3.45),
	(7, 'Better off Without a Wife', 4.46),
	(8, 'Если устал', 3.17),
	(9, 'Снайпер ', 3.22),
	(10, 'Пачка сигарет ', 4.28),
	(11, 'Virginia Avenue', 2.47),
	(12, 'Our Love Is Easy ', 5.28),
	(13, 'Kiss of Fire ', 3.27),
	(14, 'Муза ', 3.14),
	(15, 'Кассандра ', 4.31),
	(16, 'Changes ', 3.58),
	(17, 'my track', 3.25),
